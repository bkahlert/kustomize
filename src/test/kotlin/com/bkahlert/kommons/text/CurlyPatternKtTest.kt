...
class CurlyPatternKtTest {
    ...
    fun `should not match non-matching multi line string2`() {
        expectThat("""
            ▶ JavaExec(process=Process(pid=27252, exitValue="not exited"), noErrors=✅, started=false, commandLine=/var/folders/hh/739sq9w1 … /com.bkahlert.kommons.exec.o50.sh, .isA<Failed>()execTerminationCallback=${Symbols.Null}, destroyOnShutdown=✅)
            ...
            · e_by_default-CapturedOutput-UniqueId/com.bkahlert.kommons.exec.o50.sh
            · ${Symbols.Document} file:///var/folders/hh/739sq9w11lv2hvgh7ymlwwzr20wd76/T/kommons12773028758187394965/ScriptsKtTest.SynchronousExecution.should_process_log_to_console_by_default-CapturedOutput-UniqueId/com.bkahlert.kommons.exec.o50.sh
            · test output 1
            · test output 2
            · test error 1
            · test error 2
