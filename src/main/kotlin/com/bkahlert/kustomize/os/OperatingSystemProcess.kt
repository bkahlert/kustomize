...
import com.bkahlert.kustomize.os.Program.Companion.compute
import com.bkahlert.kustomize.os.Program.Companion.format
...
val STATUS: Key<List<String>, Collection<Program>> =
    Key.stringArrayKey("kustomize.os.program.status") { programs ->
