 ...
 */
@Deprecated(
    message = "Replace to easily import \"com.bkahlert.koodies.nullable.invoke\" ...",
    replaceWith = ReplaceWith("this.invoke(arg)", "com.bkahlert.koodies.nullable.invoke"),
 ...
 */
@Deprecated(
    message = "Replace to easily import \"com.bkahlert.koodies.nullable.let\" ...",
    replaceWith = ReplaceWith("this.let(block)", "com.bkahlert.koodies.nullable.let"),
    DeprecationLevel.WARNING
