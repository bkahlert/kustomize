...
fun Path.writeBytes(array: ByteArray): Path =
    apply { Files.newOutputStream(this, StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING).use { it.write(array) } }
...
fun Path.appendBytes(array: ByteArray): Path =
    apply { Files.newOutputStream(this, StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.APPEND).use { it.write(array) } }
